  ...
  <div class="flex h-screen overflow-hidden">
    ...
    <div id="sidebar" class="w-64 flex-shrink-0 min-h-screen block" style="background-color: #0f766e; color: #fff;">
      <div class="p-6">
        ...
        <nav class="space-y-2">
          <a href="indexmanager.php" class="block px-3 py-2 rounded bg-teal-800">Dashboard</a>
          <a href="auditlogsmanager.php"  class="block px-3 py-2 rounded hover:bg-teal-600 transition">Audit Logs</a>
