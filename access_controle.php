...
<body class="bg-gray-50">
  <div class="flex h-screen overflow-hidden">
    ...
    <div id="sidebar" class="w-64 flex-shrink-0 min-h-screen block" style="background-color: #0f766e; color: #fff;">
      <h2 class="sidebar-title text-xl font-bold px-6 pt-6 pb-2">Main sections</h2>
      <!-- Sidebar Navigation -->
      <nav class="space-y-2">
      ...
      <button class="create-section-btn flex items-center gap-2 px-6 py-2 hover:bg-teal-600 rounded transition w-full text-left mt-4">
